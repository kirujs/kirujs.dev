...
export const head = defineHeadContent({
  title: "Kiru - Context",
  extraMeta: [
    { name: "keywords", content: "context, createContext, composition" },
  ],
  description: "Learn how to use Context API in Kiru with createContext to share state across components using the useContext hook.",
})
