...
export const head = defineHeadContent({
  title: "Kiru - Utils",
  extraMeta: [
    { name: "keywords", content: "unwrap, className, nextIdle, flushSync, onHmr, utilities" },
  ],
  description: "Utility helpers for working with signals, scheduling work, and integrating with Kiru's runtime.",
})
