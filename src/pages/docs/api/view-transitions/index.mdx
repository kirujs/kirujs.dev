...
export const head = defineHeadContent({
  title: "Kiru - ViewTransitions",
  extraMeta: [
    { name: "keywords", content: "ViewTransitions, view transitions, animation, run, stop, AbortSignal, batching" },
  ],
  description: "Learn how to use the ViewTransitions API in Kiru to animate state changes with the browser's native View Transitions API, with automatic batching and queue management.",
})
