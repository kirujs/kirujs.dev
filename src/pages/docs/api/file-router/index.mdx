...
<Head.Content>
  ...
  <meta name="description" content="Learn how to use FileRouter in Kiru for file-based routing in SPAs with automatic route generation, layouts, dynamic routes, and client-side navigation." />
</Head.Content>
