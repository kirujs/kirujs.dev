...
export const head = defineHeadContent({
  ...
  extraMeta: [
    { name: "keywords", content: "filerouter, router, route, link, useFileRouter, SSG, static site generation" },
  ],
  description: "Learn how to use FileRouter in Kiru for file-based routing in SPAs and SSG with automatic route generation, layouts, dynamic routes, client-side navigation, and static site generation.",
})
...
<CopyInnerText>
  <Derive from={siteCodeLang}>
    {lang => (lang === "js" ? <ExamplePagesIndex /> : <ExamplePagesIndexTs />)}
  </Derive>
</CopyInnerText>
...
<CopyInnerText>
  <Derive from={siteCodeLang}>
    {lang => lang === "js" ? <ExamplePagesIdIndex /> : <ExamplePagesIdIndexTs />}
  </Derive>
</CopyInnerText>
...
<CopyInnerText>
  <Derive from={siteCodeLang}>
    {lang => lang === "js" ? <ExamplePagesLayout /> : <ExamplePagesLayoutTs />}
  </Derive>
</CopyInnerText>
...
Reference: <ExternalLink href="https://developers.cloudflare.com/pages/configuration/serving-pages/#single-page-application-spa-rendering">Cloudflare Pages - SPA rendering and 404 behavior</ExternalLink>.
