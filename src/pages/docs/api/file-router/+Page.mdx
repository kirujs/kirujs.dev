...
This approach simplifies route management and provides a familiar development experience 
similar to <ExternalLink href="https://nextjs.org/">Next.js</ExternalLink> and other modern frameworks.
