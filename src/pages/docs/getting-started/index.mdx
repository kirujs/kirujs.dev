...
export const head = defineHeadContent({
  title: "Kiru - Getting Started",
  extraMeta: [
    { name: "keywords", content: "getting started, installation, setup, npm, pnpm, yarn, bun, vite, Kiru" },
  ],
  description: "Get started with Kiru by installing it in a new project or adding it to an existing project. Learn how to set up Kiru with your preferred package manager.",
})
