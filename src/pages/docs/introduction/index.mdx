...
export const head = defineHeadContent({
  ...
  extraMeta: [
    { name: "keywords", content: "Kiru, KiruJS, introduction, framework, lightweight, documentation" },
  ],
  description: "Learn about Kiru, a lightweight framework designed to empower developers to build applications with expressivity and customizability.",
})
