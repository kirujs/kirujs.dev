...
import { files_basic, files_resource } from "./sandbox"
...
<CodeSandbox id="sandbox:basic" files={files_basic} />
...
<CodeSandbox id="sandbox:resource" files={files_resource} />
...
<ul>
  <li><Link to="/docs/components/for">`<For />`</Link></li>
  <li><Link to="/docs/api/resource">Resource</Link></li>
</ul>