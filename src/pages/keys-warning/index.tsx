...
export const head = defineHeadContent({
  ...
  extraMeta: [
    { name: "keywords", content: "error, keys warning, keys, warning" },
  ],
  description:
    "Learn about keys warnings in Kiru - why items in lists need stable key props and how to fix duplicate or missing key errors.",
})
